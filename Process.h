...
public:
    ...
    void printLogs() const; // print all logs for screen -s
	...
	std::vector<std::string>& getLogs(); // get the logs for screen -s
...
private:
    ...
    std::vector<std::string> logs; // logging for screen -s
};
